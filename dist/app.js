...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isMobile = __webpack_require__(342);

	var _isMobile2 = _interopRequireDefault(_isMobile);

	var _reactMotion = __webpack_require__(343);
	...
	var ProspectList = function ProspectList(_ref3) {
	  var prospects = _ref3.prospects;
	  var comparingId = _ref3.comparingId;
	  var onSelectProspect = _ref3.onSelectProspect;
	  return _react2["default"].createElement(
	    ...
	    _react2["default"].createElement(
	      ...
	      prospects.map(function (prospect) {
	        return _react2["default"].createElement(Prospect, { key: prospect.id, onClick: onSelectProspect.bind(undefined, prospect), comparing: comparingId === prospect.id, prospect: prospect });
	      })
	    )
	  );
	};
	...
	var Prospect = function Prospect(props) {
	  return _react2["default"].createElement(
	    "div",
	    { className: "prospectWrapper" },
	    _react2["default"].createElement(
	      "div",
	      { className: "prospect " + (props.comparing ? "is-comparing" : ""),
	        onClick: function (ev) {
	          return props.onClick(ev.target.getBoundingClientRect.bind(ev.target));
	        } },
	      _react2["default"].createElement("img", { src: props.prospect.src, width: 60 })
	    ),
	    _react2["default"].createElement(
	      "div",
	      { className: "prospectName" },
	      props.prospect.fullName
	    )
	  );
	};

	var AnimatedProspect = function AnimatedProspect(_ref4) {
	  var _ref4$ip$val = _ref4.ip.val;
	  ...
	  return _react2["default"].createElement(
	    "div",
	    { className: "prospect",
	      style: { position: "absolute", left: left, top: top, width: size, height: size, zIndex: 10 }, onClick: onClick },
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          "div",
	          { className: "header", onClick: this._stopComparing.bind(this) },
	          _react2["default"].createElement(
	            _reactMotion.Spring,
	            { defaultValue: getProfileInitialSpring(), endValue: this._getProfileEndValue.bind(this) },
	            function (ip) {
	          ...
	          _react2["default"].createElement(
	            "a",
	            { href: "http://match.com", className: "headerLogo" },
	            _react2["default"].createElement("img", { src: "src/assets/images/match-heart-logo-white.png", className: "headerLogo_image" })
	          )
	        ),
	    ...
	    value: function _handleProspectClick(_ref6, getDimensions) {
	      var id = _ref6.id;
	...
	(0, _isMobile2["default"])() ? document.getElementById('mobileBlocker').setAttribute("style", "") : (0, _reactDom.render)(_react2["default"].createElement(App, null), document.getElementById('reactContainer'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPerf = __webpack_require__(236);
	...
	function findFirstReactDOMImpl(node) {
	  ...
	  for (; node && node.parentNode !== node; node = node.parentNode) {
	    ...
	    do {
	      ...
	      !(current != null) ?  false ? invariant(false, 'findFirstReactDOMImpl(...): Unexpected detached subtree found when ' + 'traversing DOM from node `%s`.', nodeID) : invariant(false) : undefined;
	  ...
	  if (Array.isArray(children)) {
	    ...
	    if (iteratorFn) {
	      ...
	      if (false) {
	       ...
	       true ?  false ? invariant(false, 'Objects are not valid as a React child (found object with keys ' + '{%s}). If you meant to render a collection of children, use an ' + 'array instead or wrap the object using ' + 'React.addons.createFragment(object).%s', Object.keys(children).join(', '), addendum) : invariant(false) : undefined;
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components = __webpack_require__(346);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapTree = __webpack_require__(347);

	var _mapTree2 = _interopRequireDefault(_mapTree);

	var _noVelocity = __webpack_require__(353);

	var _noVelocity2 = _interopRequireDefault(_noVelocity);

	var _compareTrees = __webpack_require__(354);

	var _compareTrees2 = _interopRequireDefault(_compareTrees);

	var _mergeDiff = __webpack_require__(355);

	var _mergeDiff2 = _interopRequireDefault(_mergeDiff);

	var _animationLoop = __webpack_require__(356);

	var _animationLoop2 = _interopRequireDefault(_animationLoop);

	var _zero = __webpack_require__(359);

	var _zero2 = _interopRequireDefault(_zero);

	var _updateTree = __webpack_require__(360);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performanceNow = __webpack_require__(357);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(357)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(361);
	...
	var _presets = __webpack_require__(362);
